...
function App() {
 ...
 const[convertedAmount,setConvertedAmout]=useState(null);
 ...
 useEffect(()=>{
     if(exchangeRate!==null){
        setConvertedAmout((amount*exchangeRate).toFixed(2));
     }
 },[amount,exchangeRate]);
     ...
     <div className='currency-converter'>
        ...
        <div className="data">
          ...
          <div className='input-container'>
            ...
            <input type="number" onChange={handleAmountChange} id="amount" value={amount} />
          </div>
          <div className='input-container'>
